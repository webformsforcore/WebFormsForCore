...
<ItemGroup Condition="'$(TargetFramework)' == 'net10.0'">
    <PackageReference Include="EstrellasDeEsperanza.WebFormsForCore.Web" Version="1.5.1" />
</ItemGroup>
```
...
```
<PackageReference Include="EstrellasDeEsperanza.WebFormsForCore.Build" Version="1.5.1" ExcludeAssets="runtime" />
```
