...
// Type: System.Web.RegularExpressions.EvalExpressionRegexRunner22
...
label_43:
    ...
    protected override bool FindFirstChar()
    {
      ...
      {
        --num1;
        if (RegexRunner.CharInClass(char.ToLower(runtext[runtextpos++], CultureInfo.InvariantCulture), "\0\u0002\u0001efd"))
          goto label_4;
      }
      while (num1 > 0);
      int num2 = 0;
