...
namespace System.Web.Compilation
{
...
#else
    using Microsoft.VSDesigner.WCFModel;
#endif
    ...
    public class WCFBuildProvider : BuildProvider
    {
        ...
        {
#if !NETFRAMEWORK
            throw new NotSupportedException("DataServices not supported in WebFormsForCore.");
#else
            try
			{
        ...
        {
#if !NETFRAMEWORK
            throw new NotSupportedException("Service map files not supported in WebFormsForCore.");
#else
            try
            {
