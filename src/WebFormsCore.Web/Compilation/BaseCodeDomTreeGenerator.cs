...
namespace System.Web.Compilation
{
	...
	internal abstract class BaseCodeDomTreeGenerator
	{
		...
		protected W.CodeDomProvider _codeDomProvider;
    ...
    protected void AppendDebugComment(CodeStatementCollection statements) {
		...
		internal /*public*/ CodeCompileUnit GetCodeDomTree(W.CodeDomProvider codeDomProvider,
		...
		internal static int GetGeneratedColumnOffset(W.CodeDomProvider codeDomProvider)
		{
			object o = null;
