...
namespace System.Web.Configuration {
    ...
    internal sealed class RemoteWebConfigurationHost : DelegatingConfigHost
    {
...
#if !FEATURE_PAL && !WebFormsForCore // FEATURE_PAL does not have WindowsImpersonationContext, COM objects
            //
...
#if FEATURE_PAL || WebFormsForCore // FEATURE_PAL: singelton version
	        return s_version;
#else 
        ...
        {
#if !FEATURE_PAL && !WebFormsForCore // FEATURE_PAL has no COM objects => no encryption
