...
namespace System.Web.Compilation
{
    ...
    public sealed class ClientBuildManager : MarshalByRefObject, IDisposable
    {
        ...
        {
            HttpRuntime.CustomBinDirectory = binFolder;
        }
            ...
            TypeDescriptionProvider typeDescriptionProvider)
        {
            ...
            var AppId = ApplicationManager.CreateApplicationId(appVirtualDir, appPhysicalSourceDir);
            String domainId = ApplicationManager.ConstructAppDomainId(AppId);
            String appName = (String.Concat(AppId.ToLower(CultureInfo.InvariantCulture),
               appPhysicalSourceDir.ToLower(CultureInfo.InvariantCulture))).GetHashCode().ToString("x", CultureInfo.InvariantCulture);
        ...
        */
        ...
        public void PrecompileApplication(ClientBuildManagerCallback callback, bool forceCleanBuild)
        {
            ...
            HttpRuntime.CustomBinDirectory = _hostingParameters.ClientBuildManagerParameter.BinFolder;
