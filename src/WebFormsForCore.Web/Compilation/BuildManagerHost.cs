...
#if NETCOREAPP
		private Action<AssemblyLoadContext> _onLoadContextUnload;
#endif
...
#else
				_onLoadContextUnload = ctx => OnAppDomainUnload(this, EventArgs.Empty);
				ApplicationManager.GetLoadContext(Assembly.GetCallingAssembly()).Unloading += _onLoadContextUnload;
#endif
