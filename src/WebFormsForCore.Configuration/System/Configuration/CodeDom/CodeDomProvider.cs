...
namespace EstrellasDeEsperanza.WebFormsForCore.CodeDom.Compiler
{
	...
	public abstract class CodeDomProvider : Component
	{
		...
		/// </devdoc>
		public virtual S.LanguageOptions LanguageOptions
		{
			get
			{
				return S.LanguageOptions.None;
			}
		}
		...
		public abstract S.ICodeGenerator CreateGenerator();

#pragma warning disable 618
		public virtual S.ICodeGenerator CreateGenerator(TextWriter output)
		{
			return CreateGenerator();
		}

		public virtual S.ICodeGenerator CreateGenerator(string fileName)
		{
			return CreateGenerator();
		}
#pragma warning restore 618
		...
		public abstract S.ICodeCompiler CreateCompiler();
		...
		public virtual S.ICodeParser CreateParser()
		{
			return null;
		}
		...
		///    </para>
		/// </devdoc>
		public virtual S.CompilerResults CompileAssemblyFromDom(S.CompilerParameters options, params CodeCompileUnit[] compilationUnits)
		{
		...
		///    </para>
		/// </devdoc>
		public virtual S.CompilerResults CompileAssemblyFromFile(S.CompilerParameters options, params string[] fileNames)
		{
		...
		///    </para>
		/// </devdoc>
		public virtual S.CompilerResults CompileAssemblyFromSource(S.CompilerParameters options, params string[] sources)
		{
		...
		public virtual bool Supports(S.GeneratorSupport generatorSupport)
		{
		...
		///    </para>
		/// </devdoc>
		public virtual void GenerateCodeFromExpression(CodeExpression expression, TextWriter writer, S.CodeGeneratorOptions options)
		{
		...
		///    </para>
		/// </devdoc>
		public virtual void GenerateCodeFromStatement(CodeStatement statement, TextWriter writer, S.CodeGeneratorOptions options)
		{
		...
		///    </para>
		/// </devdoc>
		public virtual void GenerateCodeFromNamespace(CodeNamespace codeNamespace, TextWriter writer, S.CodeGeneratorOptions options)
		{
		...
		///    </para>
		/// </devdoc>
		public virtual void GenerateCodeFromCompileUnit(CodeCompileUnit compileUnit, TextWriter writer, S.CodeGeneratorOptions options)
		{
		...
		///    </para>
		/// </devdoc>
		public virtual void GenerateCodeFromType(CodeTypeDeclaration codeType, TextWriter writer, S.CodeGeneratorOptions options)
		{
			CreateGeneratorHelper().GenerateCodeFromType(codeType, writer, options);
		}

		public virtual void GenerateCodeFromMember(CodeTypeMember member, TextWriter writer, S.CodeGeneratorOptions options)
		{
...
#pragma warning disable 618
		private S.ICodeCompiler CreateCompilerHelper()
		{
			S.ICodeCompiler compiler = CreateCompiler();
			if (compiler == null)
			{
				throw new NotImplementedException(SR.GetString(SR.NotSupported_CodeDomAPI));
			}
		...
		private S.ICodeGenerator CreateGeneratorHelper()
		{
			S.ICodeGenerator generator = CreateGenerator();
			if (generator == null)
			{
				throw new NotImplementedException(SR.GetString(SR.NotSupported_CodeDomAPI));
			}
		...
		private S.ICodeParser CreateParserHelper()
		{
			S.ICodeParser parser = CreateParser();
			if (parser == null)
			{
				throw new NotImplementedException(SR.GetString(SR.NotSupported_CodeDomAPI));
			}
...
#pragma warning restore 618
		...
		/// </summary>
		internal static bool TryGetProbableCoreAssemblyFilePath(S.CompilerParameters parameters, out string coreAssemblyFilePath)
		{
