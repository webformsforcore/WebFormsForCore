...
public enum OSPlatformType { Unknown = 0, Windows, Mac, Linux, Unix, Other };
...
public class OSInfo
{
	...
	public static OSPlatformType OSPlatform => IsWindows ? OSPlatformType.Windows :
		 (IsMac ? OSPlatformType.Mac :
		 (IsLinux ? OSPlatformType.Linux :
		 (IsNetBSD || IsFreeBSD ? OSPlatformType.Unix : OSPlatformType.Other)));
