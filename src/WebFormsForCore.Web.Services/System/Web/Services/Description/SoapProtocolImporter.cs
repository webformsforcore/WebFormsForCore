...
#else 
            throw new NotSupportedException("SoapProtocolImported not supported in WebFormsForCore.");
#endif
        }
...
#else
                        throw new NotSupportedException("SoapBindingUse.Encoded not supported by WebFormsForCore.");
#endif
                    }
                    else {
...
#else
                    throw new NotSupportedException("XmlCodeExporter not supported by WebFormsForCore.");
#endif
                }
...
#else
                throw new NotSupportedException("SoapProtocolImporter not supported by WebFormsForCore.");
#endif
